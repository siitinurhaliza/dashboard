            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <li class="nav-item ">
                     ...
                     <li class="nav-item ">
                        <a class="nav-link" href="profil.php">Profil Pustaka</a>
                     </li>
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="service_box">
                                 <div class="house_icon">
                                    <img src="img/icon-1.png" class="image_1">
                                    <img src="img/icon-4.png" class="image_2">
                                 </div>
                           ...
                           <div class="col-md-4">
                              <div class="service_box active">
                                 <div class="house_icon">
                                    <img src="img/icon-5.png" class="image_1">
                                    <img src="img/icon-5.png" class="image_2">
                                 </div>
                           ...
                           <div class="col-md-4">
                              <div class="service_box">
                                 <div class="house_icon">
                                    <img src="img/icon-3.png" class="image_1">
                                    <img src="img/icon-6.png" class="image_2">
                                 </div>
